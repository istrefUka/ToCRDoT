...
=======
import { loadProjectPreviews, loadUser, saveUser, storeNewEmptyProject } from './file_utils';
import path from 'path'
import { v4 as uuidv4 } from 'uuid';
import { ProjectListener } from './communication';
import { AppendOnlyLog, uuid } from './append_only_log';
...
<<<<<<< HEAD
    ...
    web.send('update-project-preview', projects);
=======
    await openProject(web, project_id);
>>>>>>> 64ef989100e5e83f0212cabf28845d47bfc957d7
    web.send('switch-scene', 'scene-home');
    pl.open();
    web.send('update-interface', pl.broadcast_ip, pl.port);
...
=======
async function openProject(web: WebContents, projectID: uuid) {
  // TODO implement open project communication here
  // when the user presses the "leave-project"-button, return.
